...
* Support multiple devices in parallel to acclerate inference. See [demo video](https://videoportal.intel.com/media/Performance+comparison+between+1+NCS+and+3+NCSs/0_m3i8ff4m).
